  ...
  return (
    <div className="row mx-4">
      <div className="col-md-4">
        <img
          src={movie.poster}
          style={{ width: "75%", borderRadius: "20px", marginBottom: "2rem" }}
          alt=""
        />
      ...
      <div className="col-md-7" style={{ margin: "2rem" }}>
        ...
        <div className="text-white text-lg p-3">
          ...
          <p>
            <strong>Time:</strong> {formatFullDate(session.session_time)}
          </p>
          <p>
            <strong>Seats Available:</strong> {session.available_seats}
          </p>
          <hr />
          {isLoggedIn ? (
            <form onSubmit={handleSubmit} className="text-center pt-5">
              ...
              <input
                className="text-black w-[100px] py-1 px-2 "
                type="number"
                name="seats"
                min="0"
              ...
              <button
                className="text-light py-2 bg-purple-900 hover:bg-purple-700 rounded-md"
                type="submit"
            ...
            <div>
              <a href="/signin">Sign in to leave a book reservation</a>
            </div>
          )}
        </div>
      </div>
