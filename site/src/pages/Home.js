    ...
    <div className="w-full">
      ...
      <div className="flex items-start justify-start overflow-auto mx-4 mt-3">
        {movies.map((movie, index) => (
          <div className="w-[15%] flex-shrink-0 text-lg p-2" key={movie.movie_id}> 
            <button
            ...
            <p className="my-1 mx-2 text-sm font-semibold text-gray-300">{movie.duration} mins</p>
          </div>
        ))}
      </div>
      <div className="w-full p-6 flex flex-col items-start justify-start">
        ...
        <div className="w-full flex items-start justify-start overflow-auto gap-4 mb-4">
            <CommunityEvent 
              ...
              img={MusicFestialImg} 
              summary={"Get ready for three days of live music, delicious food, and fun activities at our Summer Music Festival. This family-friendly event brings the community together to celebrate the season."}
            />
            <CommunityEvent
              name="Community Gardening Workshop"
              date="May 8, 2023"
              img={GardendingImg}
              summary={"Learn about sustainable gardening practices, composting, and plant care in our Community Gardening Workshop. Green thumbs and beginners are all welcome to join and grow together."}
            />
            <CommunityEvent
